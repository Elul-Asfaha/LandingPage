...
const Inquire=()=>{
    ...
    return(
        <section className="snap-start text-white flex flex-col items-center justify-center min-h-[85vh] md:px-[13%]" id="inquireSection"> 
            <h5 className="font-black text-2xl mb-[50px] md:mb-[20px]"> Ask Us About Anything </h5>
            <form className="flex flex-col w-[80%] sm:w-[60%] gap-5 md:p-[20px]" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-1">
                    <label >First name</label>
                    <input type='text'  name='first' value={info.first} onChange={handleInput} className="outline-none py-1 px-2 border border-white text-black dark:text-white border-2"/>
                </div>

                <div className="flex flex-col gap-1">
                    <label>Last name</label>
                    <input type='text' name='last' value={info.last} onChange={handleInput} className="outline-none py-1 px-2 border border-white text-black dark:text-white border-2"/>
                </div>
                
                <div className="flex flex-col gap-1">
                    <label>Email</label>
                    <input type='email' name='email' value={info.email} onChange={handleInput} className="outline-none py-1 px-2 border border-white text-black dark:text-white border-2"/>
                </div>
